...
public class ColeccionApp {
	...
	private void comandoListarClientes() {
		...
		if (!listadoClientes.isEmpty()) {
			...
			for (Cliente cliente : listadoClientes) {
				...
				System.out.println(nombreCliente + ", " + apellidoCliente + ". DNI: " + dniCliente + ". Edad" + edadCliente);
			}
		} else {
	...
	private void comandoBuscarNombre() {
		...
		if (tipoBusqueda.equalsIgnoreCase("c")) {
			...
			System.out.println("Los clientes del usuario que contienen " + "\"" + nombreABuscarCompleto + "\"" + " en el nombre de pila son:");
			for (Cliente cliente: listadoClientes) {
				String nombreCliente = cliente.getNombre();
