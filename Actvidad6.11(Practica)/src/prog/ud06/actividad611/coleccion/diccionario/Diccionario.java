 ...
 * @throws Si el nombre o el valor son null
 */
   ...
   * @throws Si ya existe previamente una entrada con el nombre proporcionado en el diccionario
   */
   ...
   * @return Valor almacenado en la entrada con el nombre proporcionado. 
   * Si no existe una entrada con dicho nombre devuelve null
   */
